...
- 你照 README 做但卡在生圖、綠幕去背或上架規格問題。
- 你想把範例改成自家品牌的吉祥物貼圖或行銷素材。
- 你需要幫客戶或老闆做一個能展示的 PoC。
- 你想知道這個 starter 上線前還缺哪些設計(配額、付費、防濫用)。
- 你想用這個題目規劃內訓或小班課程。
...
- GitHub Pages:https://yazelin.github.io/ai-sticker-starter/
- GitHub repo:https://github.com/yazelin/ai-sticker-starter
...
> 把 AI 生圖做成能上架的成品這條線,我們做成了 line-sticker-studio(Worker proxy + 配額 + Turnstile 的正式版貼圖產生器);把工具安全交給 AI 那條線,我們做成了 AgentOS(agent 治理)與 Mori Desktop(個人 AI 管家)。
